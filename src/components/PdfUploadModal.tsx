...
export function PdfUploadModal({
  ...
  const handleConfirmAndAnalyze = () => {
    if (selectedFiles.length === 0) return;
    const promptText = `يرجى فحص وتدقيق مستند الـ PDF المرفق [نوع الوثيقة: ${documentType}] أمام المحكمة الإدارية ومحكمة الاستئناف بديوان المظالم، واستخراج:
1. منطوق المستند / الحكم أو القرار المطعون فيه وتاريخه ورقمه.
2. الثغرات الإجرائية والمواعيد النظامية (المادة 8 مرافعات).
3. مدى استحقاق بدل الحاسب الآلي والجمع بين العلاوات وفقاً للمرسوم الملكي (م/37) ونظام خدمة الأفراد والمادة 16.
4. الردود والطلبات الجازمة لإلزام الجهة الإدارية بالصرف.
${customNote.trim() ? `ملاحظات إضافية من المستشار: ${customNote}` : ''}`;
        ...
        <div className="p-6 overflow-y-auto space-y-5">
          ...
          >
            ...
            <p className="text-xs text-neutral-400 max-w-md leading-relaxed">
              يدعم قراءة واستخراج النصوص والأختام من صكوك الأحكام وقرارات التكليف في قضايا ديوان المظالم وبدل الحاسب
            </p>
