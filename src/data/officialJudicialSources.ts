...
export const OFFICIAL_JUDICIAL_SOURCES: OfficialSourceEntry[] = [
  ...
  },
  {
    ...
    cabinetResolution: 'قرار مجلس الوزراء رقم (12) — تاريخ القرار غير معتمد لحين حسم التعارض في المصدر الرسمي',
    issueDateHijri: '1435-01-22',
    publicationDateHijri: '1435-02-03',
    status: 'ساري',
    sourceAuthority: 'هيئة الخبراء بمجلس الوزراء',
    officialSourceUrl: 'https://laws.boe.gov.sa/BoeLaws/Laws/LawDetails/8f1b7079-a5f0-425d-b5e0-a9a700f26b2d/1',
    verificationNote: 'أداة الإصدار وتاريخا الإصدار والنشر والحالة متحقق منها. تاريخ قرار مجلس الوزراء رقم (12) ظهر متعارضاً في البيانات الرسمية المسترجعة؛ لذلك لا يعتمد تاريخ القرار هنا، ويجب حسمه من أصل القرار المنشور رسمياً قبل استخدامه في الاسترجاع القانوني. هذا متسق مع سجل needs-correction في الفهرس القضائي.',
  },
  {
  ...
  },
  {
    ...
    verificationNote: 'تحقق من الاسم والحالة وتاريخ الإصدار والنشر والمرسوم الملكي وقرار مجلس الوزراء من صفحة النظام الرسمية. قرار مجلس الوزراء رقم 303 وافق على نظام القضاء ونظام ديوان المظالم وآلية العمل التنفيذية لهما.',
  },
  {
    id: 'arbitration_law_1433',
    name: 'نظام التحكيم',
    category: 'قضاء وتقاضي',
    royalDecree: 'م/34 بتاريخ 24/05/1433هـ',
    cabinetResolution: '156 بتاريخ 17/05/1433هـ',
    ...
    verificationNote: 'تحقق من الاسم والحالة وتاريخ الإصدار والنشر والمرسوم الملكي وقرار مجلس الوزراء من صفحة النظام الرسمية. المادة 58 تقرر العمل بالنظام بعد ثلاثين يوماً من تاريخ نشره في الجريدة الرسمية.',
  },
  {
