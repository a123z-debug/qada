...
export const OFFICIAL_JUDICIAL_REFERENCE_INDEX: OfficialJudicialReference[] = [
  ...
  },
  {
    ...
    verificationNote: 'تم التحقق من أداة الإصدار وقرار مجلس الوزراء وتاريخ النشر والمواد المفهرسة من صفحة النظام الرسمية.',
  },
  {
    ...
    publicationDateHijri: '1428-09-23',
    status: 'official-verified',
    materialIndex: ['المادة 1', 'المادة 2', 'المادة 3', 'المادة 4', 'المادة 5', 'المادة 6'],
    amendments: [],
