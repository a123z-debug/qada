...
export const CRIMINAL_PROCEDURE_LAW_1435: OfficialReferenceSystem = {
  id: 'criminal_procedure_law_1435',
  name: 'نظام الإجراءات الجزائية',
  status: 'verified',
  royalDecree: 'م/2 بتاريخ 22/01/1435هـ',
  cabinetResolution: '12 بتاريخ 08/01/1435هـ',
  ...
  sources: [
    ...
    { authority: 'هيئة الخبراء بمجلس الوزراء', url: 'https://laws.boe.gov.sa/BoeLaws/Laws/LawDetails/9a0249b7-f835-48fa-8d1e-a9a700f1981a/1', purpose: 'المرجع الرسمي المستقل للائحة التنفيذية لنظام الإجراءات الجزائية ونص موادها.' },
  ...
  articles: [
    { number: '1', status: 'verified', sourceUrl: 'https://laws.boe.gov.sa/BoeLaws/Laws/LawDetails/8f1b7079-a5f0-425d-b5e0-a9a700f26b2d/1', note: 'مطابقة مباشرة مع المصدر الرسمي.' },
    { number: '2', status: 'verified', sourceUrl: 'https://laws.boe.gov.sa/BoeLaws/Laws/LawDetails/8f1b7079-a5f0-425d-b5e0-a9a700f26b2d/1', note: 'مطابقة مباشرة مع المصدر الرسمي.' },
    { number: '3', status: 'verified', sourceUrl: 'https://laws.boe.gov.sa/BoeLaws/Laws/LawDetails/8f1b7079-a5f0-425d-b5e0-a9a700f26b2d/1', note: 'مطابقة مباشرة مع المصدر الرسمي.' },
  ...
  regulations: [
    { name: 'اللائحة التنفيذية لنظام الإجراءات الجزائية', status: 'verified', sourceUrl: 'https://laws.boe.gov.sa/BoeLaws/Laws/LawDetails/9a0249b7-f835-48fa-8d1e-a9a700f1981a/1', note: 'ثبت وجود اللائحة ونص موادها مباشرة في بوابة هيئة الخبراء بمجلس الوزراء؛ يعتمد هذا الرابط مرجعاً رسمياً مستقلاً للائحة.' },
  ],
  amendments: [
