...
export const JUDICIARY_LAW_1428: OfficialReferenceSystem = {
  ...
  articles: [
    ...
    { number: '9', status: 'verified', sourceUrl: 'https://laws.boe.gov.sa/BoeLaws/Laws/LawDetails/ea1765a3-dec3-41a0-a32f-a9a700f26d58/1', note: 'ظهرت المادة صراحة وتحدد ترتيب محاكم القضاء العام، وفي مقدمتها المحكمة العليا.' },
    { number: '10', status: 'verified', sourceUrl: 'https://laws.boe.gov.sa/BoeLaws/Laws/LawDetails/ea1765a3-dec3-41a0-a32f-a9a700f26d58/1', note: 'ظهرت المادة صراحة وتبين مقر المحكمة العليا وتشكيلها ودوائرها وتسمية رئيسها وأعضائها.' },
    { number: '11', status: 'verified', sourceUrl: 'https://laws.boe.gov.sa/BoeLaws/Laws/LawDetails/ea1765a3-dec3-41a0-a32f-a9a700f26d58/1', note: 'ظهرت المادة صراحة وتحدد اختصاصات المحكمة العليا في مراقبة سلامة التطبيق ومراجعة الأحكام في الحالات المبينة نظاماً.' },
    { number: '12', status: 'verified', sourceUrl: 'https://laws.boe.gov.sa/BoeLaws/Laws/LawDetails/ea1765a3-dec3-41a0-a32f-a9a700f26d58/1', note: 'ظهرت المادة صراحة وتحدد كيفية انعقاد دوائر المحكمة العليا.' },
    { number: '13', status: 'verified', sourceUrl: 'https://laws.boe.gov.sa/BoeLaws/Laws/LawDetails/ea1765a3-dec3-41a0-a32f-a9a700f26d58/1', note: 'ظهرت المادة صراحة وتبين تشكيل الهيئة العامة للمحكمة العليا واختصاصها في تقرير المبادئ العامة والمسائل المحالة إليها نظاماً.' },
    { number: '14', status: 'verified', sourceUrl: 'https://laws.boe.gov.sa/BoeLaws/Laws/LawDetails/ea1765a3-dec3-41a0-a32f-a9a700f26d58/1', note: 'ظهرت المادة صراحة وتنظم إحالة العدول عن مبدأ سابق إلى الهيئة العامة للمحكمة العليا.' },
